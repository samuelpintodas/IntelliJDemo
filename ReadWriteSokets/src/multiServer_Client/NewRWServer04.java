...
public class NewRWServer04 {
	...
	public static void main(String[] args) {
		...
		PrintWriter pout; // pour envoyer l'information
		BufferedReader buffinDuClient; //pour recevoir information , un buffer pour stocker l'information
		Scanner sc; 
		int i =0;
		...
		pout = new PrintWriter(srvSocket.getOutputStream()); //channel out
       ...
       do 
       {
		...
		//reception
    	   buffinDuClient = new BufferedReader (new InputStreamReader (srvSocket.getInputStream())); //inputStrem => channel in
